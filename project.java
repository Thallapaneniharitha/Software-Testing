...
public class project {
	...
	public static void main(String[] args)throws InterruptedException {
		...
		System.setProperty("webdriver.gecko.driver","C:\\Users\\91888\\Desktop\\Selenium jar\\geckodriver.exe");
		...
		//2.open url
				...
				Thread.sleep(2000);
				w.findElement(By.linkText("REGISTER")).click();
				w.findElement(By.name("firstName")).sendKeys("Thallapaneni");
				w.findElement(By.name("lastName")).sendKeys("Haritha");
				w.findElement(By.name("phone")).sendKeys("9866392604");
				w.findElement(By.name("userName")).sendKeys("haritha97.t@gmail.com");
				w.findElement(By.name("address1")).sendKeys("Tirupati");
				...
				w.findElement(By.name("email")).sendKeys("haritha97.t@gmail.com");
			...
			//	w.findElement(By.xpath("//*[@id=\"download_now\"]")).click();
				...
				w.findElement(By.name("uploadfile_0")).sendKeys("C:\\Users\\91888\\Desktop\\Resume.docx");
				Thread.sleep(3000);
				...
				Thread.sleep(2000);
				w.findElement(By.name("email")).sendKeys("haritha97.@gmail.com");
				...
				Thread.sleep(2000);
				//home
				w.findElement(By.xpath("//*[@id=\"menu-2350\"]/nav/ul/li[1]/a/span/span")).click();
				...
				w.navigate().back();
				//testing
				w.findElement(By.xpath("//*[@id=\"menu-2350\"]/nav/ul/li[2]/a/span[1]/span")).click();
				Thread.sleep(3000);
				//sap
				Actions A=new Actions(w);
				A.moveToElement(w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[3]/div/span[1]/span"))).perform();
				w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[3]/ul/li/div/div[2]/ul/li[2]/a/span/span")).click();
				Thread.sleep(2000);
				w.navigate().back();
				w.navigate().back();
				...
				A11.moveToElement(w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[4]/div/span[1]/span"))).perform();
				w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[4]/ul/li/div/div[2]/ul/li[2]/a/span/span")).click();
				Thread.sleep(2000);
				w.navigate().back();
				w.navigate().back();
				...
				A2.moveToElement(w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[5]/div/span[1]/span"))).perform();
				w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[5]/ul/li/div/div[1]/ul/li[4]/a/span/span")).click();
				Thread.sleep(2000);
				w.navigate().back();
				w.navigate().back();
				...
				A3.moveToElement(w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[6]/div/span[1]/span"))).perform();
				w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[6]/ul/li/div/div[1]/ul/li[3]/a/span/span")).click();
				Thread.sleep(2000);
				w.navigate().back();
				w.navigate().back();
				...
				A4.moveToElement(w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[7]/div/span[1]/span"))).perform();
				w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[7]/ul/li/div/div[1]/ul/li[5]/a/span/span")).click();
				Thread.sleep(2000);
				w.navigate().back();
				w.navigate().back();
				...
				A5.moveToElement(w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[8]/div/span[1]/span"))).perform();
				w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[8]/ul/li/div/div[1]/ul/li[3]/a/span/span")).click();
				Thread.sleep(2000);
				w.navigate().back();
				w.navigate().back();
				w.navigate().back();
				...
				Thread.sleep(2000);
				//home
				w.findElement(By.xpath("//*[@id=\"rt-header\"]/div/div[2]/div/ul/li[1]/a")).click();
				w.manage().window().maximize();
				JavascriptExecutor js1 =(JavascriptExecutor) w;
						...
						w.navigate().back();
						//testing
						w.findElement(By.xpath("//*[@id=\"rt-header\"]/div/div[2]/div/ul/li[2]/a")).click();
						Thread.sleep(3000);
						//sap
						Actions A6=new Actions(w);
						A6.moveToElement(w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[3]/div/span[1]/span"))).perform();
						w.findElement(By.xpath("//*[@id=\"menu-5760-particle\"]/nav/ul/li[3]/ul/li/div/div[2]/ul/li[2]/a/span/span")).click();
						Thread.sleep(2000);
						w.navigate().back();
						w.navigate().back();
				...
				w.findElement(By.xpath("//*[@id=\"photoimg\"]")).sendKeys("C:\\Users\\91888\\Desktop\\Resume.docx");
				Thread.sleep(5000);
				w.navigate().back();
				...
				WebElement Drag3=w.findElement(By.xpath("//*[@id=\"fourth\"]/a"));
